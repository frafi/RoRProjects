...
File.open("lib/assets/TRAIN.txt", "r").each do |f|
  train_id, loop_id, category, day_1, day_2, day_3, day_4, day_5, day_6, day_7, day_8, day_9, day_10, day_11, day_12, day_13, day_14 = f.chomp.split("|")
  Train.create(
    :id => train_id, 
    :loop_id => loop_id, 
...
File.open("lib/assets/TRAIN_ROUTE.txt", "r").each do |f|
  train_id, point_seq, station_num, station_name, arrive_time, depart_time = f.chomp.split("|")
  TrainRoute.create(
    :train_id => train_id, 
